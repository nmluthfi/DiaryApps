...
public class ListNotesAdapter extends RecyclerView.Adapter<ListNotesAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_list_notes
                , viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        final ListNotesModel listNotesModel = mLists.get(position);
        ...
        viewHolder.tvItemListNotesTitle.setText(listNotesModel.getTitle());
        viewHolder.tvItemListNotesDate.setText(Tools.getNormalDate(listNotesModel.getDate()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvItemListNotesDate, tvItemListNotesTitle;
